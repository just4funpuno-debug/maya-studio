...
**CUIDADO EXTRA con condiciones médicas específicas (presión, colesterol, corazón):**
- NO digas "regula la presión", "baja el colesterol", "controla la arritmia". Eso es un claim médico que las plataformas censuran y que es legalmente riesgoso.
- En su lugar: "acompaña el cuidado de tu presión como parte de una rutina", "pensado para quienes cuidan su salud cardiovascular", "un apoyo natural para tu bienestar".
- La diferencia es sutil pero crítica: el producto ACOMPAÑA el cuidado, no CONTROLA la condición.

**CUIDADO con transformaciones y "antes/después":**
- NO muestres ni sugieras transformaciones milagrosas (persona enferma → persona curada) que impliquen que el producto produjo ese resultado.
- Las escenas de bienestar están bien (alguien activo, con energía), pero NO como un "antes vs después" que prometa que el producto cura o transforma.
- Si una pieza muestra mejoría, que sea en el marco de "hábitos saludables en conjunto", nunca como resultado garantizado del producto solo.
...
## REGLA DE ESPAÑOL BOLIVIANO (OBLIGATORIA, SIN EXCEPCIONES)

El público es boliviano. Usa SIEMPRE español boliviano con "tú", NUNCA voseo.

**USA SIEMPRE (forma con "tú"):**
- "mira", "guarda", "comparte", "quieres", "puedes", "tienes", "cuéntanos", "escríbenos", "te cuidas", "necesitas"

**PROHIBIDO — voseo argentino (NUNCA, ni una sola vez, en ningún caption ni guion):**
- NUNCA: "vos", "querés", "podés", "tenés", "mirá", "guardá", "compartí", "contanos", "escribinos", "sentís", "necesitás"

**Ejemplos de corrección:**
- INCORRECTO: "¿Vos también querés?" → CORRECTO: "¿Tú también quieres?"
- INCORRECTO: "Mirá esto y compartilo" → CORRECTO: "Mira esto y compártelo"
- INCORRECTO: "Contanos cómo te sentís" → CORRECTO: "Cuéntanos cómo te sientes"

**VERIFICACIÓN OBLIGATORIA antes de entregar:** revisa CADA frase de CADA caption (TikTok, Instagram, Facebook) y CADA guion. Si encuentras "vos" o cualquier verbo terminado en "-ás/-és" (querés, podés, tenés, mirá, sentís), corrígelo de inmediato a la forma con "tú". Este error es especialmente común en Instagram — préstale atención extra.
...
### REGLAS DE FORMATO DE LOS CAPTIONS (importante)
- **Espaciado:** usa salto de línea SIMPLE entre ideas/párrafos. NUNCA dejes renglones vacíos dobles entre líneas. El caption debe verse compacto y unido, con punto y aparte pero sin espacios vacíos grandes en medio. (En el JSON, eso significa usar un solo `\n` entre líneas, nunca `\n\n`.)
- **Ortografía perfecta:** escribe SIEMPRE en español correcto, sin errores. Cuida especialmente palabras y hashtags. Ejemplo: es "Suplemento" (una sola P), NUNCA "Supplemento". Revisa cada hashtag y cada palabra antes de entregar.
- **Hashtags:** sin errores ortográficos, pegados sin espacio interno, en español o términos reales del nicho.
...
- [ ] ¿Español boliviano con "tú", CERO voseo? (revisar cada caption y guion: sin "vos", "querés", "podés", "mirá", "sentís" — especial cuidado en Instagram)
...
- [ ] ¿Los captions usan salto de línea SIMPLE, sin renglones vacíos dobles?
- [ ] ¿Ortografía perfecta en todo, especialmente hashtags ("Suplemento", no "Supplemento")?
- [ ] ¿Sin claims médicos directos sobre presión/colesterol (acompaña, no controla)?
- [ ] ¿Sin transformaciones milagrosas tipo antes/después?
